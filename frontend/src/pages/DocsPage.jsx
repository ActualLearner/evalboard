...
export default function DocsPage() {
  return (
    <div className="space-y-3">
      <h1 className="text-4xl font-semibold tracking-tight" style={{ color: "var(--foreground)" }}>EvalBoard Documentation</h1>

      <Card>
        <h2 className="text-lg font-semibold" style={{ color: 'var(--foreground)' }}>What is EvalBoard?</h2>
        <p className="mt-3 text-[16px] leading-relaxed" style={{ color: 'var(--muted-foreground)' }}>
      ...
      <Card>
        <h2 className="text-lg font-semibold" style={{ color: 'var(--foreground)' }}>How It Works</h2>
        <ol className="mt-3 list-decimal space-y-2 pl-5 text-[16px]" style={{ color: 'var(--muted-foreground)' }}>
      ...
      <Card>
        <h2 className="text-lg font-semibold" style={{ color: 'var(--foreground)' }}>Scoring</h2>
        <p className="mt-3 text-[16px] leading-relaxed" style={{ color: 'var(--muted-foreground)' }}>
          Responses are scored using <strong>normalized exact match</strong>.
        </p>
        <ul className="mt-2 list-disc space-y-1 pl-5 text-[16px]" style={{ color: 'var(--muted-foreground)' }}>
      ...
      <Card>
        <h2 className="text-lg font-semibold" style={{ color: 'var(--foreground)' }}>Latency</h2>
        <p className="mt-3 text-[16px] leading-relaxed" style={{ color: 'var(--muted-foreground)' }}>Latency is measured in milliseconds at two levels:</p>
        <ul className="mt-2 list-disc space-y-1 pl-5 text-[16px]" style={{ color: 'var(--muted-foreground)' }}>
      ...
      <Card>
        <h2 className="text-lg font-semibold" style={{ color: 'var(--foreground)' }}>Providers</h2>
      ...
      <Card>
        <h2 className="text-lg font-semibold" style={{ color: 'var(--foreground)' }}>Tips</h2>
        <ul className="mt-3 list-disc space-y-1 pl-5 text-[16px]" style={{ color: 'var(--muted-foreground)' }}>
