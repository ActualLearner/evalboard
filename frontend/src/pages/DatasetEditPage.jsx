    ...
    <div className="space-y-3">
      ...
      {deleteState.open ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4">
          <div className="w-full max-w-lg rounded-2xl border p-5" style={{ background: 'var(--popover)', borderColor: 'var(--border)' }}>
            <h2 className="text-xl font-semibold" style={{ color: 'var(--foreground)' }}>Delete Dataset?</h2>
