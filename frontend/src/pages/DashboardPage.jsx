...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-3">
      <h1 className="text-4xl font-semibold tracking-tight" style={{ color: "var(--foreground)" }}>Dashboard</h1>
      ...
      <section className="grid grid-cols-1 gap-3 lg:grid-cols-12">
        <Card className="lg:col-span-4">
          <div className="flex items-start justify-between gap-4">
            <h2 className="text-[18px] font-light leading-none" style={{ color: 'var(--muted-foreground)' }}>Avg Score by Model</h2>
          </div>
          <div className="mt-3 h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart layout="vertical" data={avgScoreByModelData} margin={{ top: 4, right: 4, bottom: 4, left: 4 }}>
                <CartesianGrid stroke="var(--border)" strokeDasharray="3 3" />
                <XAxis type="number" domain={[0, 1]} tick={{ fill: 'var(--muted-foreground)', fontSize: 12 }} />
                <YAxis dataKey="name" type="category" width={220} tick={{ fill: 'var(--foreground)', fontSize: 11 }} />
        ...
        <Card className="lg:col-span-4">
          <h2 className="text-[18px] font-light leading-none" style={{ color: 'var(--muted-foreground)' }}>Score Distribution</h2>
        ...
        <Card className="lg:col-span-4">
          <h2 className="text-[18px] font-light leading-none" style={{ color: 'var(--muted-foreground)' }}>Top Models</h2>
      ...
      <section className="grid grid-cols-1 gap-3 lg:grid-cols-12">
        <Card className="lg:col-span-6">
          <div className="flex items-start justify-between">
            <h2 className="text-[18px] font-light leading-none" style={{ color: 'var(--muted-foreground)' }}>Score Trend Over Time</h2>
          </div>
            ...
            {scoreTrendData.length > 0 && scoreTrendProviders.length > 0 ? (
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={scoreTrendData} margin={{ top: 4, right: 8, bottom: 4, left: 0 }}>
                  <CartesianGrid stroke="var(--border)" strokeDasharray="3 3" />
                  <XAxis dataKey="label" tick={{ fill: 'var(--muted-foreground)', fontSize: 12 }} minTickGap={18} />
                  <YAxis domain={[0, 1]} tick={{ fill: 'var(--muted-foreground)', fontSize: 12 }} />
        ...
        <Card className="lg:col-span-6">
          <h2 className="text-[18px] font-light leading-none" style={{ color: 'var(--muted-foreground)' }}>Latency by Model (ms)</h2>
          <div className="mt-3 h-64 w-full">
            <ResponsiveContainer width="100%" height="100%">
      ...
      <section className="grid grid-cols-1 gap-3 lg:grid-cols-12">
        <Card className="lg:col-span-6">
          <h2 className="text-[18px] font-light leading-none" style={{ color: 'var(--muted-foreground)' }}>Top Datasets</h2>
        ...
        <Card className="lg:col-span-6">
          <h2 className="text-[18px] font-light leading-none" style={{ color: 'var(--muted-foreground)' }}>Recent Runs</h2>
          {loadingRecentRuns ? (
