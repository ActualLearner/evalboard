...
export default function NewRunPage() {
    ...
    return (
        <div className="space-y-3">
            <h1 className="text-4xl font-semibold tracking-tight text-slate-900">New Run</h1>
            {error ? <InlineError message={error} /> : null}

            <section className="grid grid-cols-1 gap-3 xl:grid-cols-2">
                <Card>
                    <h2 className="text-[20px] font-light text-slate-500">Model & Prompt</h2>
                    ...
                    {loading ? (
                        ...
                        <>
                            <div className="mt-4 space-y-3">
                                <div>
                                    <label className="mb-1 block text-[16px] font-medium text-slate-500">Load saved prompt</label>
                                    <ScrollableSelect
                                        options={[
                                ...
                                <div>
                                    <label className="mb-1 block text-[16px] font-medium text-slate-500">Prompt template</label>
                                    <textarea
                                        className={[
                                ...
                                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                                    <div>
                                        <label className="mb-1 block text-[16px] font-medium text-slate-500">Provider</label>
                                        <ScrollableSelect
                                            options={[
                                    ...
                                    <div>
                                        <label className="mb-1 block text-[16px] font-medium text-slate-500">Model</label>
                                        <ScrollableSelect
                                ...
                                <div>
                                    <label className="mb-1 block text-[16px] font-medium text-slate-500">Temperature: {Number(temperature).toFixed(1)}</label>
                                    <input
                                        type="range"
                                        min="0"
                                        max="1"
                ...
                <Card>
                    <h2 className="text-[20px] font-light text-slate-500">Dataset</h2>
                    ...
                    {loading ? (
                        ...
                        <>
                            <div className="mt-4">
                                <label className="mb-1 block text-[16px] font-medium text-slate-500">Select dataset</label>
                                <ScrollableSelect
                                    options={[
